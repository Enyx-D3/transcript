...
import 'platform_transcription_runner.dart';
...
class _ImportVideoSheetState extends State<ImportVideoSheet> {
  ...
  Future<void> _start() async {
    ...
    try {
      ...
      await _cleanupTempInput(); // ✅ only keep WAV
  ...
  Widget build(BuildContext context) {
    ...
    // ✅ same close pill behavior as your preferred ImportAudioSheet
    Widget closePill() {
      return LiquidGlass(
                  ...
                  child: Row(
                    children: [
                      Expanded(
                        child: Row(
                          children: [
                            Icon(Icons.video_file, color: fg),
...
/// ✅ match your preferred ImportAudioSheet helper (tint-only)
